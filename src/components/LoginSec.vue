...
<div id="nav">
    <div class="main">
        ...
        <form>
            ...
            <input type="email" id="email" name="email" placeholder="Enter your Email" v-model="emailInput" v-bind="text" @input="einput">
            <div id="emailerr"></div>
            <!-- {{ emailInput }} -->
            ...
            <input type="password" id="password" name="password" v-model="passInput" v-bind="password" placeholder="Enter your Password" @input="passinput">
            <div id="passerr"></div>

            <!-- {{ passInput }} -->
            <div id="wrap" @click.prevent>
                <button @click="match">
...
const match = () => {
    ...
    } else if (emailE && emailE.Email == emailInput.value) {
        console.log("object")
